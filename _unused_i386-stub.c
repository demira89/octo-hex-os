...
/* put here to prevent placement in ro .text */
...
set_mem_err (void)
{
  ...
  printf("addr: %p\n", val);
  int mmgr_access_ptr(void*);
  mem_err = mmgr_access_ptr(val);
/*  mem_err = 1;*/
}
